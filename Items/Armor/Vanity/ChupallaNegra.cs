...
namespace ChileMOD.Items.Armor.Vanity
{
    ...
    public class ChupallaNegra : ModItem
    {
        public override void SetStaticDefaults()
        {
            // Tooltip.SetDefault("Tipica Indumentaria de Huaso Cuico.");
        ...
        public override void SetDefaults()
        {
            ...
            Item.rare = Terraria.ID.ItemRarityID.Orange; // The rarity of the item
